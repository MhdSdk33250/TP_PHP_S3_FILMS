    ...
    <body>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
              ...
              <?php 
                $stmt = $bd->query('SELECT * from film');
              ?>        <div class="overflow">
                      ...
                      while( $row = $stmt->fetch()){
                        ...
                        <tr>
                          ...
                          <td><a >supprimer </a></td>
                          <td class="liensupprimer"><a href="voterfilm.php?idFilm=<?php echo $row-> id?>">Voter </a><img height='20' width='20' src="https://www.clipartmax.com/png/small/218-2188720_design-engineering-edit-icon-png-white.png"> </td>
                          <td><a href="supprimerfilm.php?mod=<?php echo $row-> id?>">supprimer </a><img height='20' width='20' src="https://icon-library.com/images/icon-delete/icon-delete-9.jpg"></td>
